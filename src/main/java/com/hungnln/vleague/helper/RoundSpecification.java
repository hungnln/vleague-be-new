...
@AllArgsConstructor
public class RoundSpecification implements Specification<Round> {
    private SearchCriteria criteria;

    @Override
    public Specification<Round> and(Specification<Round> other) {
        return Specification.super.and(other);
    }

    @Override
    public Specification<Round> or(Specification<Round> other) {
        return Specification.super.or(other);
    }

    @Override
    public Predicate toPredicate(Root<Round> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
